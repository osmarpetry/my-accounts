...
const resources = {
  en: {
    translation: {
      ...
      "resetAllSearchAndFilterCriteria": "Reset all search and filter criteria",
  ...
  es: {
    translation: {
      ...
      "filterByOwnerId": "Filtrar por ID del propietario",
  ...
  fr: {
    translation: {
      ...
      "filterByOwnerId": "Filtrer par ID du propriétaire",
  ...
  de: {
    translation: {
      ...
      "filterByOwnerId": "Nach Eigentümer-ID filtern",
